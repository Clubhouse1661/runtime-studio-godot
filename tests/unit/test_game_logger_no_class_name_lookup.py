...
that script fails with:
    ...
    the current scope.
    at: GDScript::reload (res://addons/runtime_studio/runtime/game_logger.gd:44)
...
Fix: `const _LogBacktrace := preload("res://addons/runtime_studio/utils/log_backtrace.gd")`
...
def test_game_logger_preloads_log_backtrace_by_path() -> None:
    ...
    assert 'preload("res://addons/runtime_studio/utils/log_backtrace.gd")' in source, (
