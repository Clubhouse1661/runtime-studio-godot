"""MCP tool for configuring AI clients to use Runtime Studio for Godot."""
...
_DESCRIPTION = """\
Configure AI clients to use this Runtime Studio for Godot MCP server. Writes / removes
