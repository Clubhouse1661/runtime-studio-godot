...
- ``Sec-Fetch-Site`` is also checked when present: any value other than
  ...
  against ``/runtime-studio-godot/status``, where browsers send a loopback ``Host``
...
FORBIDDEN_BODY = (
    ...
    b"see https://github.com/Clubhouse1661/runtime-studio-godot issue #345 for details\n"
)
...
class LocalhostOnlyHTTPMiddleware:
    ...
    streamable-HTTP session manager, before ``/runtime-studio-godot/status``, and
