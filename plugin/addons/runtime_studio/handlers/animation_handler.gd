...
const AnimationPresets := preload("res://addons/runtime_studio/handlers/animation_presets.gd")
const AnimationValues := preload("res://addons/runtime_studio/handlers/animation_values.gd")
