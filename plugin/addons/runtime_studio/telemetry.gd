...
##      EditorSettings.
##   2. The `runtime_studio/telemetry_enabled` EditorSetting — set through the
...
## `src/runtime_studio/transport/websocket.py::_PLUGIN_EVENT_NAMES`. Update
## both together.
...
const PENDING_PLUGIN_RELOAD_KEY := "runtime_studio/pending_plugin_reload_event"
